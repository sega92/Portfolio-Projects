                            ...
                            <div class="row">   <!-- First row -->
                                ...
                                <div class="row"> <!--Second Row--> 
                                    <div class="col-md-6 col-md-offset-3"  style="border: solid 2px black;"> <!-- Second Row, Column-->
                                        ...
                                        <br />
                                        <asp:TextBox ID="Screen" runat="server" BorderStyle="Solid" class="center-block img-responsive screen" Font-Size="X-Large" Height="31px" Style="text-align: right" Width="538px" ReadOnly="True">0</asp:TextBox>
                                        <br />
                                        <br />
                                        <div class="col-lg-6">
